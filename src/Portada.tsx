...
import boda from "./assets/boda.jpeg"; // tu imagen real

const fechaBoda = new Date("2025-11-29T00:00:00");

function Portada() {
  return (
    <div className="w-full max-w-sm mx-auto rounded-xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <h1 className="text-2xl font-bold font-serif">Lucía & Iván</h1>
          <p className="text-sm mt-1 tracking-widest">29.11.2025</p>
        </div>
      </div>

      {/* Sección inferior con cuenta regresiva */}
